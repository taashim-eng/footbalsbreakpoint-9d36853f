...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "The Break Point" },
      ...
      { name: "twitter:title", content: "Overview — The Break Point" },
      { name: "twitter:description", content: "Statistical anomaly detection across 2,800+ FIFA World Cup matches. Key findings at a glance." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/60ef7520-1543-4194-97a2-48ffe5805f4f/id-preview-bc8e5f37--52fbeedc-1dea-41ae-9e38-e61ce3a732df.lovable.app-1783524178682.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/60ef7520-1543-4194-97a2-48ffe5805f4f/id-preview-bc8e5f37--52fbeedc-1dea-41ae-9e38-e61ce3a732df.lovable.app-1783524178682.png" },
    ],
    links: [
